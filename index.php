                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="images\cal4.jpg" class="d-block w-100" alt="..." height="500" width="800">
                      </div>
                      <div class="carousel-item">
                        <img src="images\cal0.jpg" class="d-block w-100" alt="..." height="500" width="800">
                      </div>
                      <div class="carousel-item">
                        <img src="images\cal3.jpg" class="d-block w-100" alt="..." height="500" width="800">
                      </div>
                    </div>
                  </div>
            </div>
